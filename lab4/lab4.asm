...
forcode:
	...
	sw $t2,temp
	print(temp)
	move $t9,$t1		# not print space if $t0 equals $t1-1
	sub $t9,$t9,1
	beq $t0,$t9,endif1
...
### print unsorted array
 ...
 print_unsorted:
 	...
 	clr_buf						
 	move $a0,$t5					# prepare for itoa
 	la $a1,str_buf
 	jal itoa					# result will store in str_buf
 	printStr(str_buf)				#print the number
 	move $t9,$t4
 	sub $t9,$t9,1
 	beq $t3,$t9,endif2
	printStr(space)
...
## calling convention:
## $a0 = your integer
## $a1 = address of first char in string buffer, result will be written here
 itoa:
 	sw $ra,($sp)
 	sub $sp,$sp,4
 	li $t6,10
