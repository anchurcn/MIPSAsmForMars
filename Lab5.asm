...
.macro getCoordinates(%input %x %y)
    srl     %x    %input    16    #0x00XX00YY shift 16/4 : 4 times to the right = 0x000000xx
    sll     %y      %input    16    #0x00YY0000
    srl     %y    %y    16    #0x000000YY    
.end_macro
...
clear_bitmap: nop
        lw      $3,originAddress
        addi	$3,$3,65536		#loop until equals originAddress+128*128*4
        lw      $2,originAddress
loop1:
        sw      $4,0($2)
        addiu   $2,$2,4
